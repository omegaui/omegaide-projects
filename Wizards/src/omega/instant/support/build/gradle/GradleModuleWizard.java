...
public class GradleModuleWizard extends JFrame{
	private int pressX;
	private int pressY;
	...
	private String projectPath = "/home/ubuntu/Documents/Omega Projects/GradleHello";
	
	public GradleModuleWizard(){
		setUndecorated(true);
		setSize(700, 400);
	...
	public void generateApplicationTemplate(String language){
		...
		File moduleFile = new File(projectPath, moduleName);
	...
	public void generateBuildTemplate(String descriptor){
		...
		try(PrintWriter writer = new PrintWriter(new File(projectPath + File.separator + nameField.getText(), buildName))){
