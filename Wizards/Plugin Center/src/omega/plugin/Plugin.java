...
public interface Plugin {
     ...
     */
     ...
     @Deprecated
     default java.util.LinkedList<java.awt.image.BufferedImage> getImages() { // To get plugin's screenshots or working images if any else null
     ...
     default String getSize() { // To get plugin's install size
          return "-1";
     }
     /**
     * Plugin Interactions
     */
     default boolean needsRestart() { // To get whether the plugin needs IDE restart to work, true by default
          return true;
     }
}
